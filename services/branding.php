  ...
  <section class="section section-bg">
    <div class="container" style="max-width: 1049.6px; margin: 0 auto;">
      <div class="content-block fade-in-section">
        <h3>What is Branding & Creative Design?</h3>
        <p>Branding & Creative Design is the art and science of shaping a unique identity for your business. It includes logo design, brand guidelines, visual storytelling, and creative assets that make your business memorable and trusted.</p>
      </div>
      <div class="content-block fade-in-section">
        ...
        <ul>
          ...
          <li>Emotional connection with customers</li>
      ...
      <div class="content-block fade-in-section">
        ...
        <ul>
          <li>Attracts ideal customers</li>
          <li>Drives customer loyalty</li>
          <li>Sets you apart from competitors</li>
          <li>Enhances marketing effectiveness</li>
          <li>Boosts perceived value</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <section class="section" style="background: #fff;">
    <div class="container">
      ...
      <div class="fade-in-section" style="display: flex; justify-content: center; margin-top: 40px;">
        <img src="../assets/INVERTED.png" alt="Branding Benefits Visual" style="width: 1008px; height: 460px; border-radius: 15px; object-fit: cover; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
      </div>
            ...
            <a href="seo.php" class="text-decoration-none">
              <div class="card h-100 border-0 shadow-sm service-card d-flex flex-row align-items-center p-4 position-relative overflow-hidden" style="border-radius: 0.7rem;">
                <div class="service-card-content flex-grow-1 position-relative z-2">
                  ...
                  <p class="text-muted mb-0 service-subtitle">Boost your website’s visibility and ranking on search engines.</p>
                </div>
                <span class="service-card-arrow ms-auto"><i class="bi bi-arrow-right"></i></span>
                <div class="service-card-image position-absolute top-0 end-0 h-100 d-flex align-items-center justify-content-center" style="width:38%;min-width:260px;">
