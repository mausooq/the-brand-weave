...
<head>
  ...
  <title>Email Marketing | The Brand Weave</title>
...
<?php include '../navbar.php'; ?>
  ...
  <section class="section service-hero">
    ...
    <h1 class="service-title fade-in-section">Email Marketing</h1>
    <p class="fade-in-section">Run personalized email campaigns to nurture leads and drive conversions.</p>
  </section>
    ...
    <div class="container" style="background: #fff; max-width: 1049.6px; margin: 0 auto;">
      <div class="statistics-grid">
        ...
        <div class="stat-card fade-in-section">
          ...
          <div class="stat-label">Avg ROI per $1</div>
        </div>
        <div class="stat-card fade-in-section">
      ...
      <div class="seo-card">
        ...
        <div class="seo-columns">
          <div class="seo-col">
            ...
            <ul>
              <li><span class="seo-icon"><i class="bi bi-graph-up"></i></span><span>High ROI (Return on Investment)</span></li>
              <li><span class="seo-icon"><i class="bi bi-person-lines-fill"></i></span><span>Personal communication</span></li>
              <li><span class="seo-icon"><i class="bi bi-currency-dollar"></i></span><span>Increases sales and conversions</span></li>
              <li><span class="seo-icon"><i class="bi bi-people"></i></span><span>Customer increases retention</span></li>
              <li><span class="seo-icon"><i class="bi bi-arrows-expand"></i></span><span>Cost-effective and scalable</span></li>
              <li><span class="seo-icon"><i class="bi bi-bar-chart"></i></span><span>Average status result</span></li>
            </ul>
          </div>
          <div class="seo-col">
            <h3>How Email Marketing Helps Your Business</h3>
            <ul>
              <li><span class="seo-icon"><i class="bi bi-funnel"></i></span><span>Nutrition proceeds through funnel</span></li>
              <li><span class="seo-icon"><i class="bi bi-arrow-repeat"></i></span><span>Drive repeat shopping</span></li>
              <li><span class="seo-icon"><i class="bi bi-robot"></i></span><span>Customer automates the trip</span></li>
              <li><span class="seo-icon"><i class="bi bi-megaphone"></i></span><span>Promotes the content and offer</span></li>
              <li><span class="seo-icon"><i class="bi bi-people-fill"></i></span><span>A loyal customer forms the base</span></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <section class="section" style="background: #fff;">
    <div class="container px-3 benefits-responsive-container" style="max-width: 1200px; margin: 0 auto;">
      <h2 class="mb-5 fade-in-section benefits-heading" style="font-size: 3.5rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; color: #18362b; text-align: left;">Benefits of Email Marketing</h2>
      <div class="row">
        <div class="col-12 col-md-6 col-lg-3 fade-in-section" style="text-align: left;">
          <div style="font-size: 1.25rem; font-weight: 700; text-transform: uppercase; color: #18362b; margin-bottom: 0.5rem; letter-spacing: 0.5px;">High ROI</div>
          <div style="color: #64748b; font-size: 1.08rem; line-height: 1.5; font-weight: 400;">Email marketing delivers one of the highest ROIs in digital marketing—earning $40+ for every $1 spent.</div>
        </div>
        <div class="col-12 col-md-6 col-lg-3 fade-in-section" style="text-align: left;">
          <div style="font-size: 1.25rem; font-weight: 700; text-transform: uppercase; color: #18362b; margin-bottom: 0.5rem; letter-spacing: 0.5px;">Personal Communication</div>
          <div style="color: #64748b; font-size: 1.08rem; line-height: 1.5; font-weight: 400;">Segment your audience and send tailored messages based on behavior, interests, or past purchases.</div>
        </div>
        <div class="col-12 col-md-6 col-lg-3 fade-in-section" style="text-align: left;">
          <div style="font-size: 1.25rem; font-weight: 700; text-transform: uppercase; color: #18362b; margin-bottom: 0.5rem; letter-spacing: 0.5px;">Increases Sales & Conversions</div>
          <div style="color: #64748b; font-size: 1.08rem; line-height: 1.5; font-weight: 400;">Timely email campaigns influence purchase decisions and recover lost sales through remarketing.</div>
        </div>
        <div class="col-12 col-md-6 col-lg-3 fade-in-section" style="text-align: left;">
          <div style="font-size: 1.25rem; font-weight: 700; text-transform: uppercase; color: #18362b; margin-bottom: 0.5rem; letter-spacing: 0.5px;">Customer Retention</div>
          <div style="color: #64748b; font-size: 1.08rem; line-height: 1.5; font-weight: 400;">Regular, value-driven emails keep your brand top-of-mind and build long-term loyalty.</div>
        </div>
      </div>
      <!-- Benefits Image -->
      <div class="fade-in-section benefits-image-center" style="display: flex; justify-content: center; margin-top: 40px;">
        <img src="../assets/email_sub.jpg" alt="Benefits Visual" style="width: 1008px; height: 460px; border-radius: 15px; object-fit: cover; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
      </div>
