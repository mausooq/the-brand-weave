...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
     <meta name="description" content="We help your business grow online with digital marketing, SEO, social media, ads, and website design. Get more customers with our expert team." />
    <title>Top Digital Marketing Company | Grow Your Business Online</title>
    <!-- Bootstrap 5 CSS -->
    <link
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="./web logo png.png">
    ...
    <meta name="msapplication-TileImage" content="./web logo png.png">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="tbwNavbar">
      ...
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-lg-3">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="./about-us-digital-marketing-agency/">About us</a>
        </li>
        <li class="nav-item">
